 ...
 * timeouts, and perform other coreframework actions using the Selenium WebDriver API.
 *

 */
@SuppressWarnings({"unused", "rawtypes"})
public class SeleniumUtils extends WebUtil {
  ...
  public List<String> getElementsTextContent(String xpath) {
    ...
    List<WebElement> elements = getElements(xpath);
    for (WebElement element : elements) {
      data.add(CommonUtils.replaceLineBreaksWithSpace(element.getText()).trim());
    }
    return data;
  }
  ...
  public List<String> getElementsTextContent(By element) {
    ...
    List<WebElement> elements = getElements(element);
    for (WebElement ele : elements) {
      data.add(CommonUtils.replaceLineBreaksWithSpace(ele.getText()).trim());
    }
    return data;
  }
  ...
  public void takeScreenshot(String filepath) {
    ...
    FileUtils.copyFile(screenshot, new File(filepath), "Screenshot");
  }
   ...
   */
   public static void waitAndClickByLocator(By element, Duration duration) {
    try {
