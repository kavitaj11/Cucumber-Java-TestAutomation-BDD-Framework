...
import org.k11techlab.bdd.mobiletestframework.base.AppiumUtils;
import org.k11techlab.bdd.mobiletestframework.base.appiumengine.AppiumEngine;
import org.k11techlab.bdd.mobiletestframework.pageobjects.makemytripexample.android.HomePageAndroid;
import org.k11techlab.bdd.mobiletestframework.pageobjects.makemytripexample.base.HomePageBase;
import org.k11techlab.bdd.mobiletestframework.pageobjects.makemytripexample.ios.HomePageIOS;
...
public class HomePage extends AppiumUtils {
    ...
    public HomePage(AppiumDriver driver) {
        super(driver);
        homePage = AppiumEngine.isAndroid() ? new HomePageAndroid() : new HomePageIOS();
    }
    ...
    public void closeLoginPopUp() {
        ...
        if (waitAndCheckIsVisible(loginAlertCloseButton, Duration.ofSeconds(3))) {
            CucumberUtils.logToReport("Login Alert is Visible...");
            SeleniumUtils.click(getElement(loginAlertCloseButton));
        } else CucumberUtils.logToReport("Login Alert is NOT Visible...");
    }
    ...
    public void closeAdsIfAny() {
        if (isVisible(homePage.getAdBar())) {
            CucumberUtils.logToReport("Ad is Visible...");
            click(homePage.getAdBarCloseButton());
        } else CucumberUtils.logToReport("Ad is NOT Visible...");
    }
    ...
    public void clickOnLob(String lobName) {
        SeleniumUtils.waitAndClickByLocator(homePage.getLobItem(lobName), Duration.ofSeconds(5));
    }
}